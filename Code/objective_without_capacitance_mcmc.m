function Idiff = objective_without_capacitance_mcmc(X0,D,V,noise,model,protocol,model_type,temperature)
...
for prot = 1 : size( protocol, 2 )
    
    sig = noise( prot );
    [I,O]=SimulatingData(model_type,protocol{ prot },X0',V{ prot },temperature);
